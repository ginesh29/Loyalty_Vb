...
Partial Class testPDF
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            lblVoucherNo.Text = objBll.TrnId
            ...
            lblBalancePnts.Text = Convert.ToString(objBll.Appr_Points - objBll.Redm_Points)
    ...
    Sub ShowPDF()
        ...
        PdfWriter.GetInstance(doc, New FileStream(Request.PhysicalApplicationPath + "\PDF\" + "3.pdf", FileMode.Create))
        doc.Open()
        'doc.AddCreationDate()

        doc.Add(New Paragraph(Space(63) + lblCompany.Text))
        doc.Add(New Paragraph(Space(55) + "Redemption Voucher "))


        doc.Add(New Paragraph(Space(400)))

        doc.Add(New Paragraph("Voucher Number" + Space(4) + ": " + lblVoucherNo.Text.Trim()))
        doc.Add(New Paragraph("Redeemed Date" + Space(5) + ": " + lblRedDt.Text.Trim()))
        ...
        doc.Add(New Paragraph(Space(5000)))
        ...
        'a.Control.Add(New Paragraph("zzzzzzzzzzz"))

        doc.Close()
        Response.Redirect("~/PDF/3.pdf")
    End Sub
    'Sub ShowHello()
    '    Dim doc As Document = New Document
